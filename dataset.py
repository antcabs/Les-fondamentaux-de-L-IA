...
import numpy as np
import matplotlib
matplotlib.use('Agg')  # Mode sans interface graphique (compatible tous environnements)
...
plt.close()
print("\n[OK] iris_pairplot.png sauvegardé")
...
plt.close()
print("[OK] confusion_matrix.png sauvegardé")

# ============================================================
# ÉTAPE 4 — Tuning hyperparamètres & détection overfitting
# ============================================================
...
plt.close()
print("[OK] overfitting.png sauvegardé")
...
try:
    ...
    plt.close()
    print("[OK] shap_summary.png sauvegardé")
    ...
    plt.close()
    print("[OK] feature_importance.png sauvegardé")

except ImportError:
    print("[ATTENTION] SHAP non installé — exécutez : pip install shap")

print("\n=== TERMINÉ — tous les graphiques sont dans le dossier courant ===")
